...
path_to_save = '/home/erick/LASSO_EBIC_recon';
mkdir(path_to_save);
...
tic
display('=================================================');
LASSO_EBIC_SD(path_to_data, path_to_mask, b_vector, b_value, format_to_save_fODF, path_to_save, lambda1, lambda2, lambda_csf);
display('=================================================');
total_time1 = toc;
