...
path_to_save = '/home/erick/NNLS_BSS_EBIC_recon';
mkdir(path_to_save);
...
tic
display('=================================================');
NNLS_BSS_EBIC_SD(path_to_data, path_to_mask, b_vector, b_value, format_to_save_fODF, path_to_save, lambda1, lambda2, lambda_csf);
display('=================================================');
total_time1 = toc;
